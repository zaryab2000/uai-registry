...
Standard procedure for upgrading AgentRegistry or ReputationRegistry on Push Chain.
...
|----------|-------|------------|
| AgentRegistry | `0x13499d36729467bd5C6B44725a10a0113cE47178` | `0x062021b898e2693f41bb69d463c016cda568794e` |
| ReputationRegistry | `0x90B484063622289742516c5dDFdDf1C1A3C2c50C` | `0x32e0b8a0fdd30c8a64bf013ea8d224ed79cbcab8` |
...
```bash
forge inspect AgentRegistry storage-layout --pretty > /tmp/old-layout.txt
# (make changes)
forge inspect AgentRegistry storage-layout --pretty > /tmp/new-layout.txt
...
# 3. ReputationRegistry health check
cast call $REP_PROXY "getAgentRegistry()(address)" --rpc-url $PC_RPC
...
1. **Verify on Blockscout:**
   ...
   forge verify-contract --chain 42101 --verifier blockscout \
       ...
       <NEW_IMPL> src/AgentRegistry.sol:AgentRegistry \
